...
class ArucoNavigatorNode(Node):
    ...
    def depth_callback(self, msg):
        ...
        try:
            ...
            cv2.resizeWindow('Depth Camera', 640, 480)  # Adjust width and height as needed
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            cv2.resizeWindow('Camera Feed With Markers', 640, 480)  # Adjust width and height as needed
