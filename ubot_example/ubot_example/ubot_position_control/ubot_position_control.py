...
from ubot_example.ubot_example.ubot_position_control.ubot_path import UbotPath

terminal_msg = """
Ubot Position Control
------------------------------------------------------
...
class UbotPositionControl(Node):

    def __init__(self):
        super().__init__('ubot_position_control')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Ubot position control node has been initialised.")
    ...
    def generate_path(self):
        ...
        if self.get_key_state is False:
            ...
            if self.step == 1:
                ...
                twist, self.step = UbotPath.turn(angle, angular_velocity, self.step)
            ...
            # Step 2: Go Straight
                ...
                twist, self.step = UbotPath.go_straight(distance, linear_velocity, self.step)
