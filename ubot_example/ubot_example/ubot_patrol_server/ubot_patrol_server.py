...
from ubot_example.ubot_example.ubot_patrol_server.ubot_path \
    import UbotPath
from ubot_msgs.action import Patrol


class UbotPatrolServer(Node):

    def __init__(self):
        super().__init__('ubot_patrol_server')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Ubot patrol action server has been initialised.")
    ...
    *******************************************************************************"""
    ...
    async def execute_callback(self, goal_handle):
        ...
        while (feedback_msg.left_time > 0):
            ...
            twist = Twist()
            twist = UbotPath.drive_circle(radius, speed)
